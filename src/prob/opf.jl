...
function build_mc_opf(pm::AbstractUBFModels)
    ...
    variable_mc_transformer_power(pm)
    variable_mc_transformer_power_voltage(pm)
    variable_mc_transformer_voltage_sqr(pm)
    variable_mc_transformer_w_realcurrent(pm)
    variable_mc_transformer_w_imagcurrent(pm)
    variable_mc_transformer_current_real(pm)
    variable_mc_transformer_current_imaginary(pm)
    variable_mc_generator_power(pm)
    variable_mc_load_power(pm)
    variable_mc_storage_power(pm)
